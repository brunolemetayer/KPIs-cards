/**
 * Node.js script to render card deck as static HTML without dependencies
 *
 * To run this script:
 * 1. Save card data in a data.js file that exports cardData array
 * 2. Run: node node-renderer.js > output.html
 */
...
/**
 * Renders a metadata badge (task, objective, etc.)
 */
...
function renderCardGrid(cards) {
  return `
    <div style="display: grid; grid-template-columns: repeat(1, 1fr); gap: 1.5rem; margin-top: 2rem;">
